document.addEventListener('DOMContentLoaded', (event) => {
	...
	demo.onclick = function(){
		...
		hideSplash();
		message.innerHTML = 'Click on the rectangular outline to use as the textile placement table.';
	...
	const demoSvg = `<svg version="1.1" id="svg2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="1147.592px" height="1397.27px" viewBox="0 0 1147.592 1397.27" enable-background="new 0 0 1147.592 1397.27" xml:space="preserve">
